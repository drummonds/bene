"""
Django settings for bene project.
...
LOCAL_APPS = [
    ...
    'xeroapp.apps.XeroConfig', # Adding replacement
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'bene.contrib.sites.migrations'
}
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/bene'),
}
...
ACCOUNT_ADAPTER = 'bene.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'bene.users.adapters.SocialAccountAdapter'
