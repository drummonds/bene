...
class Product(models.Model):
    ...
    keywords = models.CharField(max_length = 100, default ='matress;matrass;mattrass', blank = True)
    ...
    manufacturer_description = models.TextField(max_length = 2000, blank = True, default ='Manuf desc')
...
class Size(models.Model):
    ...
    imperial_width = models.DecimalField(max_digits = 10, decimal_places=2, null = True, blank = True,
                                           help_text="Width of product in inches")
    imperial_length = models.DecimalField(max_digits = 10, decimal_places=2, null = True, blank = True,
                                           help_text="Length of product in inches")
    metric_width = models.DecimalField(max_digits = 10, decimal_places=2, null = True, blank = True,
                                           help_text="Width of product in cm")
    metric_length = models.DecimalField(max_digits = 10, decimal_places=2, null = True, blank = True,
...
class Material(models.Model):
    ...
    thread_count = models.DecimalField(max_digits = 10, decimal_places=2, blank = True,
    ...
    coating = models.CharField(max_length = 135, blank = True,
...
class Spec(models.Model):
    ...
    QUILTING_PATTERN = (
        (UNKNOWN_QUILTING_PATTERN, 'Unkown',),
        (DIAMOND_3_INCH, '3" Diamond',),
        (SQUARE_2_INCH, '2" Square',),
        (STRIGHT_6_INCH, '6" Straight',),
    )
    quilting_pattern = models.CharField(
        max_length=10,
        choices = QUILTING_PATTERN,
        default=UNKNOWN_QUILTING_PATTERN)
    ...
    fixing = models.CharField(
        max_length=10,
        choices = FIXING_CHOICES,
        default=ELASTIC_STRAP)
